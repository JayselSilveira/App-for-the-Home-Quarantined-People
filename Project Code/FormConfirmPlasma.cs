...
{
    public partial class FormConfirmPlasma : Form
    {
        int flag = 0;
        Form parentForm;
        public FormConfirmPlasma(Form form)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("You need to enter name and password to verify.");
            }
        }
